//  -------------------------------------------------------------------------------------------------
//  <copyright file="ITemplateBasedReqIfBuilder.cs" company="Starion Group S.A.">
// 
...
namespace DEHReqIF.Services
{
    ...
    /// <summary>
    /// Definition of the <see cref="ITemplateBasedReqIfBuilder"/> interface
    /// </summary>
    public interface ITemplateBasedReqIfBuilder
    {
        /// <summary>
